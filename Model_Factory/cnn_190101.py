...
def inference_l2reg(images, **kwargs): #batchSize=None, phase='train', outLayer=[13,13], existingParams=[]
    ...
    ############# CONV_M4  -  64 x 4
    fireOut, prevExpandDim, l2regLayer = model_base.conv_fire_module_l2regul('conv_m4', fireOut, prevExpandDim,
                                                                  {'cnn3x3': modelShape[4]},
                                                                  wd=wd, 
                                                                  stride=[1, 1, 1, 1],
                                                                  **kwargs)
    l2reg += l2regLayer
    ############# CONV_M5  -  64 x 4
    fireOut, prevExpandDim, l2regLayer = model_base.conv_fire_module_l2regul('conv_m5', fireOut, prevExpandDim,
                                                                  {'cnn1x3': modelShape[5]},
                                                                  wd=wd, 
                                                                  stride=[1, 1, 2, 1],
                                                                  **kwargs)
